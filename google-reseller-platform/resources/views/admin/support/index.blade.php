<x-app-layout>
    <x-slot name="title">
        Admin - Support Tickets - Google Workspace Reseller
    </x-slot>
    
    <x-slot name="description">
        Manage all support tickets from customers.
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-6">
                        ...
                        <p class="text-gray-600">Manage all customer support tickets</p>
                    </div>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">No support tickets have been created yet.</p>
                        </div>
                    @endif
                </div>
            </div>
